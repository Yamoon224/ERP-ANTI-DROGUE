            ...
            <div class="card cta-box overflow-hidden">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <img class="ms-3" src="{{ asset('images/svg/email-campaign.svg') }}" width="92" alt="Generic placeholder image">
                    </div>
                </div>
                <!-- end card-body -->
            </div>
            ...
            <div class="card card-h-100">
                <div class="card-body">
                    ...
                    <ul class="nav float-end d-none d-lg-flex">
                        <li class="nav-item">
                            <a class="nav-link text-muted" href="dashboard-analytics.html#">Today</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-muted" href="dashboard-analytics.html#">7d</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="dashboard-analytics.html#">15d</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-muted" href="dashboard-analytics.html#">1m</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-muted" href="dashboard-analytics.html#">1y</a>
                        </li>
                    </ul>
        ...
        <div class="col-12">
            <div class="card">
                <div class="d-flex card-header justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <a href="dashboard-analytics.html#" class="dropdown-toggle arrow-none card-drop" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="col-xl-4 col-lg-12">
            <div class="card">
                <div class="d-flex card-header justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <a href="dashboard-analytics.html#" class="dropdown-toggle arrow-none card-drop p-0" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="mdi mdi-dots-vertical"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:void(0);" class="dropdown-item">Refresh Report</a>
